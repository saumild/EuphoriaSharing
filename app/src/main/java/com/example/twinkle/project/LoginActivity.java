...
public class LoginActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                bt_send.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (validateEmail(til_resetPass.getText().toString(), til_resetPass)) {

                            //Sending password reset email using sendPasswordResetEmail() method
                            firebaseAuth.sendPasswordResetEmail(til_resetPass.getText().toString()).addOnSuccessListener(LoginActivity.this, new OnSuccessListener<Void>() {
                                @Override
                ...
                if (validateEmail(email, til_email) &&
                    ...
                    firebaseAuth.signInWithEmailAndPassword(email, password).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                        ...
                        public void onSuccess(AuthResult authResult) {
                            ...
                            storeData.putString("pd", til_password.getText().toString());
                            storeData.apply();
    ...
    private void initialize() {
        til_email = (EditText) findViewById(R.id.til_email);
        til_password = (EditText) findViewById(R.id.til_password);
    ...
    private boolean validateEmail(String string, EditText textInputLayout) {
        if (string.equals("")) {
