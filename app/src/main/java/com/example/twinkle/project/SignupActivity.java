...
public class SignupActivity extends AppCompatActivity {
    ...
    private EditText til_name;
    private EditText til_password;
    private EditText til_confirmPass;
    private EditText til_email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra("contains", false)) {
            til_email.setText(getIntent().getStringExtra("email"));
            til_password.setText(getIntent().getStringExtra("password"));
            til_confirmPass.setText(getIntent().getStringExtra("password"));
        }
        ...
        bt_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                name = til_name.getText().toString();
                password = til_password.getText().toString();
                confirm = til_confirmPass.getText().toString();
                email = til_email.getText().toString();
                    ...
                    myAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(SignupActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                StorageReference myStorageReference = FirebaseStorage.getInstance().getReference( "profile_images"+"/"+name.toString());
                                StorageReference uploadReference =
                                        myStorageReference.child(name);// creating a unique filename
    ...
    private void createUser(String name, String email,String picpath) {

        User user1 = new User(name, email,picpath);
        FirebaseUser user=myAuth.getCurrentUser();
        datareference.child(user.getUid()).setValue(user1);
    ...
    private void initialize() {
        ...
        til_name = (EditText) findViewById(R.id.til_name_reg);
        til_password = (EditText) findViewById(R.id.til_password_reg);
        til_confirmPass = (EditText) findViewById(R.id.til_confirm_reg);
        til_email = (EditText) findViewById(R.id.til_email_reg);
    ...
    private boolean validateConfirm(String string) {
        if (string.equals("")) {
            ...
            return false;
        } else if (!string.equals(til_password.getText().toString())) {
